...
class SVGRenderer{
	...
	public function __construct(array $modules){
		...
		$this->rows = count($modules);
		$this->cols = count($modules[0]);
	}
	...
	public function render(): string{
		$ms = $this->module_size;
		$w = ($this->cols + $this->margin * 2) * $ms;
		$h = ($this->rows + $this->margin * 2) * $ms;
